...
import { BrainCircuit, Bot, BookOpen, MessageSquare, BarChart2, Users, Settings, Shield, Sparkles, GitBranch } from 'lucide-react';
...
const AiAdmin = () => {
    const menuItems = [
        { to: '/admin/ai/treinamento', icon: BrainCircuit, title: 'Treinamento e Conhecimento', description: `Faça upload de documentos e áudios para treinar a ${AI_CONFIG.name}.`, color: 'border-purple-600' },
        { to: '/admin/ai/personalidade', icon: Bot, title: 'Personalidade e Voz', description: `Ajuste o comportamento e o tom de voz da ${AI_CONFIG.name}.`, color: 'border-indigo-600' },
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4 sm:p-6 lg:p-8">
            <Helmet>
                <title>Admin da {AI_CONFIG.name} - Portal Paraíso Online</title>
            ...
            >
                <div className="mb-10 text-center">
                    ...
                    <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-indigo-700">
                        Administração da {AI_CONFIG.name}
                    </h1>
