...
const AdminManageBanners = () => {
    ...
    const [banners, setBanners] = useState([
        ...
        { id: 2, name: 'Banner Guia Comercial', type: 'Imagem', position: 'Guia Comercial - Lateral', status: 'Inativo' },
    ]);
    ...
    const handleUpload = (e) => {
        ...
        toast({
            ...
            description: `Seu banner foi recebido.`,
        });
    ...
    return (
        <div className="min-h-screen p-4 sm:p-6 md:p-8" style={{ backgroundColor: '#e0e0e0' }}>
            <Helmet>
                <title>Admin: Gerenciar Banners</title>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 flex items-center">
                            <ImageIcon className="mr-3 text-teal-600" /> Gerenciar Banners
                        </h1>
                        <p className="text-gray-700 mt-1">Administre os banners de publicidade do portal.</p>
                    </div>
